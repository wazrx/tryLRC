...
XWSYNTH_DUMMY_CLASS(UIColor_XWAdd)

#define CLAMP_COLOR_VALUE(v) (v) = (v) < 0 ? 0 : (v) > 1 ? 1 : (v)

void XW_RGB2HSL(CGFloat r, CGFloat g, CGFloat b,
...
void XW_HSL2RGB(CGFloat h, CGFloat s, CGFloat l,
...
void XW_RGB2HSB(CGFloat r, CGFloat g, CGFloat b,
...
void XW_HSB2RGB(CGFloat h, CGFloat s, CGFloat v,
                CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(h);
    CLAMP_COLOR_VALUE(s);
    CLAMP_COLOR_VALUE(v);
...
void XW_RGB2CMYK(CGFloat r, CGFloat g, CGFloat b,
...
void XW_CMYK2RGB(CGFloat c, CGFloat m, CGFloat y, CGFloat k,
                 CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(c);
    CLAMP_COLOR_VALUE(m);
    CLAMP_COLOR_VALUE(y);
...
void XW_HSB2HSL(CGFloat h, CGFloat s, CGFloat b,
...
void XW_HSL2HSB(CGFloat h, CGFloat s, CGFloat l,
...
+ (UIColor *)xw_colorWithHue:(CGFloat)hue
               saturation:(CGFloat)saturation
                lightness:(CGFloat)lightness
                    alpha:(CGFloat)alpha {
    CGFloat r, g, b;
    XW_HSL2RGB(hue, saturation, lightness, &r, &g, &b);
...
+ (UIColor *)xw_colorWithCyan:(CGFloat)cyan
                   magenta:(CGFloat)magenta
                    yellow:(CGFloat)yellow
                     ...
                     alpha:(CGFloat)alpha {
    CGFloat r, g, b;
    XW_CMYK2RGB(cyan, magenta, yellow, black, &r, &g, &b);
    return [UIColor colorWithRed:r green:g blue:b alpha:alpha];
...
+ (UIColor *)xw_colorWithGradientStyle:(XWGradientStyle)gradientStyle withFrame:(CGRect)frame andColors:(NSArray *)colors {
    ...
    switch (gradientStyle) {
        case XWGradientStyleLeftToRight: {
        ...
        case XWGradientStyleTopToBottom:
        default: {
            backgroundGradientLayer.colors = cgColors;
            UIGraphicsBeginImageContextWithOptions(backgroundGradientLayer.bounds.size,NO, [UIScreen mainScreen].scale);
            [backgroundGradientLayer renderInContext:UIGraphicsGetCurrentContext()];
