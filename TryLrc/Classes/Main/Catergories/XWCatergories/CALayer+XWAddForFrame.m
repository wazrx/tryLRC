...
XWSYNTH_DUMMY_CLASS(CALayer_XWAddForFrame)


@implementation CALayer (XWAddForFrame)
...
- (void)setXw_centerX:(CGFloat)xw_centerX {
    ...
    self.frame = frame;
    self.position = CGPointMake(xw_centerX, self.position.y);
...
- (void)setXw_centerY:(CGFloat)xw_centerY {
    ...
    self.frame = frame;
    self.position = CGPointMake(self.position.x, xw_centerY);
}
