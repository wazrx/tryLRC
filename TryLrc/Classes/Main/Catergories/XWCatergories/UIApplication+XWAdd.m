...
- (BOOL)isPirated {
    ...
    if (![self _xw_fileExistInMainBundle:@"_CodeSignature"]) {
        return YES;
    }
    
    if (![self _xw_fileExistInMainBundle:@"SC_Info"]) {
        return YES;
    }
...
- (BOOL)_xw_fileExistInMainBundle:(NSString *)name {
