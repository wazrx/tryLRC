...
typedef NS_ENUM (NSUInteger, XWGradientStyle) {
    XWGradientStyleLeftToRight,//左->右渐变
    XWGradientStyleRadial,//中间扩散
    XWGradientStyleTopToBottom//上->下渐变
};
...
#ifndef XWatermelonC
#define XWatermelonC [UIColor xWatermelonColor]
#endif

#ifndef XWhiteC
#define XWhiteC [UIColor xWhiteColor]
#endif
...
#ifndef XWatermelonDarkC
#define XWatermelonDarkC [UIColor xWatermelonColorDark]
#endif

#ifndef XWhiteDarkC
#define XWhiteDarkC [UIColor xWhiteColorDark]
#endif
